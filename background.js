// E-Okul Gelişim Raporu Asistanı (BRKNET Digital) — Background Service Worker
...
chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
  switch (msg.type) {
    ...
    case MSG.OPEN_SCRAPER_TAB: {
      ...
      // BRKNET Digital: Simülasyon sayfası desteği
      if (sender.tab?.url?.includes("demo.html")) {
        const mockGrades = [
          { no: "101", name: "Ahmet Yılmaz", score: 92, selected: true },
          { no: "102", name: "Ayşe Demir", score: 78, selected: true },
          { no: "103", name: "Mehmet Kaya", score: 45, selected: true },
          { no: "104", name: "Elif Çelik", score: 88, selected: true },
          { no: "105", name: "Can Avcı", score: 20, selected: true }
        ];
        
        chrome.storage.local.set({
          [STORAGE.grades]:    mockGrades,
